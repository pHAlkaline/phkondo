 ...
 */
	public $migration = array(
		...
		'down' => array(
			'drop_table' => array(
				'accounts', 'accounts_fiscal_years', 'administrators', 'budget_statuses', 'budget_types', 'budgets', 'comments', 'condos', 'entities', 'entities_fractions', 'entity_types', 'fiscal_years', 'fractions', 'insurance', 'insurance_types', 'invoice_conference_statuses', 'invoice_conferences', 'maintenance', 'movement_categories', 'movement_operations', 'movement_types', 'movements', 'note_statuses', 'note_types', 'notes', 'ratings', 'receipt_counters', 'receipt_notes', 'receipt_payment_types', 'receipt_statuses', 'receipts', 'share_distributions', 'share_periodicities', 'users'
			),
		),
	);
