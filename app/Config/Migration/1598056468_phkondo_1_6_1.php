<?php
class Phkondo161 extends CakeMigration {
 ...
 * @var string
 */
	public $description = 'phkondo_1_6_1';
 ...
 */
	public $migration = array(
		...
		'down' => array(
			'drop_table' => array(
				'accounts', 'accounts_fiscal_years', 'administrators',  'budget_statuses', 'budget_types', 'budgets', 'condos', 'entities', 'entities_fractions', 'entity_types', 'fiscal_years', 'fraction_types', 'fractions', 'insurance_types', 'insurances', 'invoice_conference_statuses', 'invoice_conferences', 'maintenances', 'movement_categories', 'movement_operations', 'movement_types', 'movements', 'note_statuses', 'note_types', 'notes', 'receipt_counters', 'receipt_notes', 'receipt_payment_types', 'receipt_statuses', 'receipts', 'share_distributions', 'share_periodicities', 'suppliers', 'support_categories', 'support_priorities', 'support_statuses', 'supports', 'users'
			),
		),
	);
