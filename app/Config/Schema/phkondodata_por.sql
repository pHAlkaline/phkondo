...
INSERT INTO `movement_categories` (`id`, `name`, `active`, `modified`, `created`) VALUES (14,'Fundo de caixa',1,NOW(),NOW());
INSERT INTO `movement_categories` (`id`, `name`, `active`, `modified`, `created`) VALUES (15,'Despesas Administrativas',1,NOW(),NOW());
INSERT INTO `movement_categories` (`id`, `name`, `active`, `modified`, `created`) VALUES (16,'PT Comunicações',1,NOW(),NOW());
INSERT INTO `movement_categories` (`id`, `name`, `active`, `modified`, `created`) VALUES (17,'Despesas bancárias',1,NOW(),NOW());
INSERT INTO `movement_categories` (`id`, `name`, `active`, `modified`, `created`) VALUES (18,'Liquidação de conta',1,NOW(),NOW());
INSERT INTO `movement_categories` (`id`, `name`, `active`, `modified`, `created`) VALUES (19,'Juros Bancários',1,NOW(),NOW());
INSERT INTO `movement_categories` (`id`, `name`, `active`, `modified`, `created`) VALUES (20,'Criação fundo comum de reserva',1,NOW(),NOW());
INSERT INTO `movement_categories` (`id`, `name`, `active`, `modified`, `created`) VALUES (21,'Liquidação fundo comum de reserva',1,NOW(),NOW());
INSERT INTO `movement_categories` (`id`, `name`, `active`, `modified`, `created`) VALUES (22,'Abertura de conta bancária',1,NOW(),NOW());
INSERT INTO `movement_categories` (`id`, `name`, `active`, `modified`, `created`) VALUES (23,'Requisição de cheques',1,NOW(),NOW());
INSERT INTO `movement_categories` (`id`, `name`, `active`, `modified`, `created`) VALUES (24,'Conta Poupança',1,NOW(),NOW());
INSERT INTO `movement_categories` (`id`, `name`, `active`, `modified`, `created`) VALUES (25,'Acerto de contas',1,NOW(),NOW());
INSERT INTO `movement_categories` (`id`, `name`, `active`, `modified`, `created`) VALUES (26,'Reunião Extraordinária',1,NOW(),NOW());
INSERT INTO `movement_categories` (`id`, `name`, `active`, `modified`, `created`) VALUES (27,'Detergentes',1,NOW(),NOW());
INSERT INTO `movement_categories` (`id`, `name`, `active`, `modified`, `created`) VALUES (28,'Adiantamento',1,NOW(),NOW());
INSERT INTO `movement_categories` (`id`, `name`, `active`, `modified`, `created`) VALUES (29,'Outros',1,NOW(),NOW());
...
-- Dump completed on 2022-12-21 14:30:31
