...
INSERT INTO `users` (`id`, `name`, `username`, `password`, `role`, `active`, `modified`, `created`) VALUES (1,'Administrador','admin','b8ebe5d64db2e878e267d8b3d0ad4b0753ea9d38','admin',1,NOW(),NOW());
