...
INSERT INTO `budget_statuses` ( `id`, `name`, `active`, `modified`, `created`) VALUES (1, 'In Sospeso',1,NOW() ,NOW());
...
INSERT INTO `movement_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (14, 'Fondo Cassa',1,NOW() ,NOW());
INSERT INTO `movement_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (15, 'Costi di Amministrazione',1,NOW() ,NOW());
INSERT INTO `movement_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (16, 'Telefono',1,NOW() ,NOW());
INSERT INTO `movement_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (17, 'Costi Bancari',1,NOW() ,NOW());
INSERT INTO `movement_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (18, 'Liquidazione dei conti',1,NOW() ,NOW());
INSERT INTO `movement_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (19, 'Interessi bancari',1,NOW() ,NOW());
INSERT INTO `movement_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (20, 'Creazione del fondo cassa',1,NOW() ,NOW());
INSERT INTO `movement_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (21, 'Liquidazione del fondo cassa',1,NOW() ,NOW());
INSERT INTO `movement_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (22, 'Apertura conto corrente',1,NOW() ,NOW());
INSERT INTO `movement_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (23, 'Requisizione assegni',1,NOW() ,NOW());
INSERT INTO `movement_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (24, 'Conto corrente',1,NOW() ,NOW());
INSERT INTO `movement_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (25, 'Liquidazione pagamenti',1,NOW() ,NOW());
INSERT INTO `movement_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (26, 'Riunione straordinaria', 1,NOW() ,NOW());
INSERT INTO `movement_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (27, 'Societa di pulizie',1,NOW() ,NOW());
INSERT INTO `movement_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (28, 'Disavanzo',1,NOW() ,NOW());
INSERT INTO `movement_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (29, 'loro',1,NOW() ,NOW()); 
...
INSERT INTO `movement_operations` ( `id`, `name`, `active`, `modified`, `created`) VALUES (3, 'Funzionamento Interno',1,NOW() ,NOW());
INSERT INTO `movement_operations` ( `id`, `name`, `active`, `modified`, `created`) VALUES (4, 'Trasferimenti',1,NOW() ,NOW());
INSERT INTO `movement_operations` ( `id`, `name`, `active`, `modified`, `created`) VALUES (5, 'Contante',1,NOW() ,NOW());
...
INSERT INTO `support_statuses` ( `id`, `name`, `active`, `modified`, `created`) VALUES (2,'Aperto',1,NOW(),NOW());
INSERT INTO `support_statuses` ( `id`, `name`, `active`, `modified`, `created`) VALUES (3,'Chiuso',1,NOW(),NOW());
...
INSERT INTO `support_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (1,'Avvenimento',1,NOW(),NOW());
INSERT INTO `support_categories` ( `id`, `name`, `active`, `modified`, `created`) VALUES (2,'Richiesta di informazioni',1,NOW(),NOW());
...
INSERT INTO `support_priorities` ( `id`, `name`, `order`, `active`, `modified`, `created`) VALUES (2,'Normale',2,1,NOW(),NOW());
INSERT INTO `support_priorities` ( `id`, `name`, `order`, `active`, `modified`, `created`) VALUES (3,'Bassa',3,1,NOW(),NOW());
...
-- Dump completed on 2023-12-21 2:30:31 PM
