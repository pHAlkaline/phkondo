...
INSERT INTO `movement_operations` ( `id`, `name`, `active`, `modified`, `created`) VALUES (2, 'Internal Operation',1,NOW() ,NOW());
...
INSERT INTO `movement_operations` ( `id`, `name`, `active`, `modified`, `created`) VALUES (5, 'Check',1,NOW() ,NOW()); 
...
INSERT INTO `note_statuses` ( `id`, `name`, `active`, `modified`, `created`) VALUES (1, 'Waiting For Payment',1,NOW() ,NOW());
...
INSERT INTO `receipt_statuses` ( `id`, `name`, `active`, `modified`, `created`) VALUES (2, 'Waiting For Payment',1,NOW() ,NOW());
...
-- Dump completed on 2022 2:30:31 PM
