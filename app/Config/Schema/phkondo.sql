...
CREATE TABLE `receipts` (
  ...
  CONSTRAINT `receipts_ibfk_2` FOREIGN KEY (`entity_id`) REFERENCES `entities` (`id`) ON UPDATE CASCADE,
...
CREATE TABLE `supports` (
  ...
  `modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `SUPPORTCATEGORY` (`support_category_id`),
  KEY `SUPPORTPRIORITY` (`support_priority_id`),
  KEY `SUPPORTSTATUS` (`support_status_id`),
  KEY `CONDO` (`condo_id`),
  KEY `FRACTION` (`fraction_id`),
  KEY `ENTITY` (`entity_id`),
  KEY `ASSIGNEDUSER` (`assigned_user_id`),
  ...
  CONSTRAINT `fk_support_4` FOREIGN KEY (`condo_id`) REFERENCES `condos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
