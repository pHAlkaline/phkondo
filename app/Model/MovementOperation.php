...
/**
 * MovementOperation Model
 *
 */
class MovementOperation extends AppModel {
     ...
     * @var string
     */
    public $order = 'MovementOperation.name';
    ...
    public function hasMovements($id = null) {
        ...
        $result = ClassRegistry::init('Movement')->find('count', array('conditions' => array('Movement.movement_operation_id' => $id)));
