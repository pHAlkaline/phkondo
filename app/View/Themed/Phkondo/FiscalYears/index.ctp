                ...
                <table data-empty="<?= __('Empty'); ?>"  class="footable table table-hover table-condensed">
                    <thead>
                        <tr>
                            ...
                            <th data-breakpoints="xs"><?php echo $this->Paginator->sort('open_date'); ?></th>
                            <th data-breakpoints="xs"><?php echo $this->Paginator->sort('close_date'); ?></th>
                        ...
                        <?php foreach ($fiscalYears as $fiscalYear): ?>
                            ...
                            <tr>
                                ...
                                <td class="actions hidden-print">
                                    ...
                                    <?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span> ', array('action' => 'delete', $fiscalYear['FiscalYear']['id'], '?' => $this->request->query), array('title' => __('Remove'), 'class' => 'btn btn-default btn-xs' . $deleteDisabled, 'escape' => false, 'confirm' => __('DANGER!!! ALL ASSOCIATED DATA WILL BE LOST!').PHP_EOL.__('Are you sure you want to delete # %s?', $fiscalYear['FiscalYear']['title']))); ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
