    ...
    <div class="col-sm-2">
        <div id="sidebar" class="hidden-print actions sidebar-offcanvas">
            ...
            <ul class="nav nav-pills nav-stacked">			
                ...
                <li ><?php echo $this->Form->postLink(__('Delete Fiscal Year'), array('action' => 'delete', $fiscalYear['FiscalYear']['id'], '?' => $this->request->query), array('class' => 'btn ' . $deleteDisabled, 'confirm' => __('DANGER!!! ALL ASSOCIATED DATA WILL BE LOST!').PHP_EOL.__('Are you sure you want to delete # %s?', $fiscalYear['FiscalYear']['title']))); ?> </li>
        ...
        <div class="fiscalYears view">
            ...
            <table class="table table-hover table-condensed">
                <tbody>
                    ...
                    <tr>
                        <td><strong><?php echo __('Open Date'); ?></strong></td>
                        <td>
                    ...
                    <tr>		
                        <td><strong><?php echo __('Close Date'); ?></strong></td>
                        <td>
