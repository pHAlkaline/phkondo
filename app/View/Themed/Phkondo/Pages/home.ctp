...
<div class="jumbotron">
    <h1><?php echo $this->Html->image('logo_phkondo_flat.svg', array('alt' => 'pHKondo'));?></h1>
    ...
    <p class="text-primary">Without limiting, its main features are management of Properties, Owners, Representatives, Budgets, Fees, Accounts, Movements, Billing, Payment Receipts, Maintenance, Insurances, and more.</p>
