...
<div class="jumbotron">
    ...
    <p class="text-primary">Without limiting, its main features are management of Properties its Owners and Representatives, Budgets, Fees, Bank Accounts and Movements, Billing, Payment Receipts, Maintenance, Insurances, and more.</p>
