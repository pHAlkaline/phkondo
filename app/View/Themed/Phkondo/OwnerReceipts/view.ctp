                    ...
                    <div role="tabpanel" class="tab-pane" id="send-by-email" aria-labelledby="send-by-email-tab">
                        ...
                        <?php echo $this->Form->create('Receipt', array(
                            ...
                            <?php echo $this->Form->input('id'); ?>
                                ...
                                <div class="form-group">
                                <?php echo $this->Form->input('subject', array('required'=>'required', 'class' => 'form-control', 'default' => $config['receipt_subject']!=''?$config['receipt_subject']:$config['subject'])); ?>
                                </div><!-- .form-group -->

                                <div class="form-group">
                                <?php echo $this->Form->input('message', array('required'=>'required', 'type'=>'textarea','class' => 'form-control', 'default' => $config['receipt_message'])); ?>
                                </div><!-- .form-group -->
