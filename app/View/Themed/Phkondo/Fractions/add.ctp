...
<div id="page-container" class="row">
    ...
    <div id="page-content" class="col-sm-9">
        ...
        <div class="fractions form">
            ...
            <?php echo $this->Form->create('Fraction', array('class' => 'form-horizontal',                 'role' => 'form',                 'inputDefaults' => array(                     'class' => 'form-control',                     'label' => array('class' => 'col-sm-2 control-label'),                     'between' => '<div class="col-sm-6">',                     'after' => '</div>',                     ))); ?>
            <fieldset>
                <h2><?php echo __('Add Fraction'); ?></h2>
