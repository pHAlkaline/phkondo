<div id="page-container" class="row row-offcanvas row-offcanvas-left">
    ...
    <div class="col-sm-2">
        ...
        <div id="sidebar" class="hidden-print actions sidebar-offcanvas">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li><?php echo $this->Html->link(__('View %s', __n('Payment Advice', 'Payment Advices', 1)), array('action' => 'view', $this->Form->value('PaymentAdvice.id'), '?' => $this->request->query), array('class' => 'btn')); ?></li>
                <li><?php echo $this->Html->link(__('List Payment Advices'), array('action' => 'index', '?' => $this->request->query), array('class' => 'btn')); ?></li>
    ...
    <div id="page-content" class="col-sm-10">
        ...
        <div class="payment_advices form">
            ...
            <fieldset>
                <legend><?php echo __('Cancel Payment Advice'); ?></legend>
