            ...
            <ul class="nav navbar-nav" style="padding: 0 10px 0 5px;">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><?php echo $this->Html->link('<span class="glyphicon glyphicon-asterisk"></span> ' . __('Insurance Types'), array('plugin' => '', 'controller' => 'insurance_types', 'action' => 'index'), array('escape' => false)); ?></li>
                        <li><?php echo $this->Html->link('<span class="glyphicon glyphicon-warning-sign"></span> ' . __('Support Categories'), array('plugin' => '', 'controller' => 'support_categories', 'action' => 'index'), array('escape' => false)); ?></li>

                        <h6 class="dropdown-header"><?php echo __('Accounting'); ?></h6>
                        <li><?php echo $this->Html->link('<span class="glyphicon glyphicon-book"></span> ' . __('Movement Categories'), array('plugin' => '', 'controller' => 'movement_categories', 'action' => 'index'), array('escape' => false)); ?></li>
                        <li><?php echo $this->Html->link('<span class="glyphicon glyphicon-cog"></span> ' . __('Movement Operations'), array('plugin' => '', 'controller' => 'movement_operations', 'action' => 'index'), array('escape' => false)); ?></li>
                        <?php
                        ...
                        <li><?php echo $this->Html->link('<span class="glyphicon glyphicon-envelope"></span> ' . __('Email'), array('plugin' => '', 'controller' => 'email', 'action' => 'config'), array('escape' => false)); ?></li>
                        <?php } ?>
