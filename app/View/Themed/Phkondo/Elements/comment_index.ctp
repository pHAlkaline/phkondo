                ...
                <span class="username">
                    ...
                    <span class="text-muted pull-right">
                        ...
                        <?php if ($comment['user_id'] == AuthComponent::user('id') || AuthComponent::user('role') == 'admin'): ?>
                            <?php echo $this->Form->postlink('<button class="btn btn-default btn-xs"><span class="glyphicon glyphicon-remove"></span></button> ', array('controller' => 'comments', 'action' => 'delete', $comment['id']), array('title' => __('Delete'), 'escape' => false, 'confirm' => __('Are you sure you want to delete # %s?', substr($comment['content'], 0, 20) . '...'))); ?>
                        <?php endif; ?>
                    </span>
