    ...
    <div id="page-content" class="col-sm-12">
        ...
        <div class="index">
            ...
            <div class="actions hidden-print col-sm-3">
                <?php echo $this->Html->link('<span class="glyphicon glyphicon-plus-sign"></span> '.__('Add Administrator'), array('action' => 'add','?'=>$this->request->query), array('class' => 'btn btn-primary', 'style' => 'margin: 8px 0; float: right;', 'escape' => false));
                ?>
            </div><!-- /.actions -->
                ...
                <table data-empty="<?= __('Empty'); ?>"  class="footable table table-hover table-condensed">
                    <thead>
                        <tr>
                            ...
                            <th data-breakpoints="xs"><?php echo $this->Paginator->sort('title'); ?></th>
                        ...
                        <?php foreach ($administrators as $administrator): ?>
                            <tr>
                                ...
                                <td class="actions hidden-print">
                                    ...
                                    <?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span> ', array('action' => 'delete', $administrator['Administrator']['id'],'?'=>$this->request->query), array('title'=>__('Remove'),'class' => 'btn btn-default btn-xs','escape'=>false), __('DANGER!!! ALL ASSOCIATED DATA WILL BE LOST!').PHP_EOL.__('Are you sure you want to delete # %s?', $administrator['Administrator']['title'])); ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
