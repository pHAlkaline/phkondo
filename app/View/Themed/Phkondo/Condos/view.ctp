        ...
        <div id="sidebar" class="hidden-print actions sidebar-offcanvas">
            <ul class="nav nav-pills nav-stacked nav-stacked">
                ...
                <?php if ($has_fiscal_year) : ?>
                    ...
                    <li><?php echo $this->Html->link('<span class="glyphicon glyphicon-chevron-right"></span> ' . __n('Payment Note', 'Payment Notes', 2), array('controller' => 'owner_notes', 'action' => 'create', '?' => array('condo_id' => $condo['Condo']['id'])), array('class' => 'btn ', 'escape' => false)); ?> </li>
                <?php endif; ?>
