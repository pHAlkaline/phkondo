    ...
    <div class="install form">
        ...
        <fieldset>
            ...
            <div class="form-group">
                            <p><?php echo __('USING GOOGLE ACCOUNT?'); ?></p>
                            <p>
                                <?php echo __('You will need to have access for less secure apps enabled in your Google account for this to work'); ?>:
                                <a target="_blank" class="reference external" href="https://support.google.com/accounts/answer/6010255">
                                    <?php echo __('Allowing less secure apps to access your account'); ?></a>.
                            </p>
                        </div>
            <hr/>
            <div class="form-group">
                <?php
                echo $this->Form->input('host', array('class' => 'form-control', 'label' => __d('email','Host')));
                ?>
            </div>
            ...
            <div class="form-group">
                <?php
                echo $this->Form->input('port', array('class' => 'form-control', 'label' => __d('email','Port')));
                ?>
            </div>
            <div class="form-group">
                <?php
                echo $this->Form->input('username', array('autocomplete'=>'off','class' => 'form-control', 'label' => __('Username')));
                ?>
            </div>
            <div class="form-group">
                <?php
                echo $this->Form->input('password', array('autocomplete'=>'new-password', 'class' => 'form-control', 'label' => __('Password')));
                ?>
            </div>
            <hr/>
