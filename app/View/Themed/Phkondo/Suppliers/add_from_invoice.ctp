    ...
    <div class="col-sm-3">
        ...
        <div id="sidebar" class="hidden-print actions sidebar-offcanvas">
            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                <?php if (isset($invoiceId) && $invoiceId != null) { ?>
                    <li ><?php echo $this->Html->link(__('Return'), array('controller' => 'invoice_conference', 'action' => 'edit', $invoiceId,'?'=>$this->request->query),array('class'=>'btn')); ?></li>
                <?php } else { ?>
                    <li ><?php echo $this->Html->link(__('Return'), array('controller' => 'invoice_conference', 'action' => 'add','?'=>$this->request->query),array('class'=>'btn')); ?></li>
                <?php } ?>
            </ul>
