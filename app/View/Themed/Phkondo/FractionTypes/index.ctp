    ...
    <div id="page-content" class="col-sm-12">
        ...
        <div class="index">
            ...
            <div class="actions hidden-print col-sm-3">
                <?php echo $this->Html->link('<span class="glyphicon glyphicon-plus-sign"></span> ' . __('New Fraction Type'), array('action' => 'add'), array('class' => 'btn btn-primary', 'style' => 'margin: 14px 1px; float: right;', 'escape' => false)); ?>
            </div><!-- /.actions -->
        </div><!-- /.actions -->
                ...
                <tbody>
                    <?php foreach ($fractionTypes as $fractionType): ?>
                        <tr>
                            ...
                            <td><?php echo h($fractionType['FractionType']['modified']); ?>&nbsp;</td>
                            <td><?php echo h($fractionType['FractionType']['created']); ?>&nbsp;</td>
