                ...
                <table data-empty="<?= __('Empty'); ?>"  class="footable table table-hover table-condensed">
                    <thead>
                        <tr>
                            ...
                            <th data-breakpoints="xs"><?php echo $this->Paginator->sort('insurance_company'); ?></th>
                            <th data-breakpoints="xs"><?php echo $this->Paginator->sort('policy'); ?></th>
                            <th data-breakpoints="xs"><?php echo $this->Paginator->sort('InsuranceType.name', __('Insurance Type')); ?></th>
