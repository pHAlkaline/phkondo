    ...
    <div class="col-sm-2">
        <div id="sidebar" class="hidden-print actions sidebar-offcanvas">
            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                <li ><?php echo $this->Form->postLink(__('Delete Account'), array('action' => 'delete', $this->Form->value('Account.id'),'?'=>$this->request->query), array('class' => 'btn', 'confirm' => __('DANGER!!! ALL ASSOCIATED DATA WILL BE LOST!').PHP_EOL.__('Are you sure you want to delete # %s?', $this->Form->value('Account.title')))); ?></li>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <?php echo $this->Form->input('main_account', array('class' => 'checkbox styled', 'label' => __('Main Account'), 'div' => array('class' => 'checkbox checkbox-success'), 'between' => '', 'after' => '')); ?>
                    </div>
                </div><!-- .form-group -->
